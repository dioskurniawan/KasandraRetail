package id.kasandra.retail.bluetoothprint;
...
public class DeviceList extends ListActivity {
    ...
    private int initDevicesList() {
        ...
        Toast.makeText(getApplicationContext(),
                ...
                "Sedang mencari perangkat Bluetooth", Toast.LENGTH_LONG)
                .show();
            try {
                pDialog = new ProgressDialog(new ContextThemeWrapper(DeviceList.this, android.R.style.Theme_Holo_Light_Dialog));
    ...
    final Runnable handlerTask = new Runnable() {
        ...
        public void run() {
            ...
            if (n >= 15) {
                if (isLoading) {
                    //Toast.makeText(MainActivity.this, "Failed to display data, please check your internet connection", Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int reqCode, int resultCode, Intent intent) {
        ...
        switch (reqCode) {
            case REQUEST_ENABLE_BT:
                //Toast.makeText(DeviceList.this, "Perangkat Bluetooth tidak ditemukan2"+resultCode, Toast.LENGTH_SHORT).show();
    ...
    private final BroadcastReceiver mBTReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            //Toast.makeText(DeviceList.this, "Action : "+action, Toast.LENGTH_SHORT).show();
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                try {
                    if (btDevices == null) {
                        ...
                        //Toast.makeText(DeviceList.this, "Perangkat Bluetooth tidak ditemukan", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    if (btDevices.getPosition(device) < 0) {
                        ...
                        mArrayAdapter.add(device.getName() + "\n"
                                + device.getAddress() + "\n" );
                        mArrayAdapter.notifyDataSetInvalidated();
                        //Toast.makeText(DeviceList.this, "Perangkat Bluetooth ditemukan", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception ex) {
                // ex.fillInStackTrace();
                }
